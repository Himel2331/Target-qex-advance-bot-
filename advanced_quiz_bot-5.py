...
def format_draft_info(draft: Any) -> str:
    ...
    lines = [
        ...
        f"Time / question: <b>{base.fmt_question_time(draft['question_time'])}</b>",
...
async def send_private_results(context, session_id: str) -> None:
    ...
    for p in participants:
        ...
        text = (
            ...
            f"⏱ Time: <b>{base.html_escape(rank_item.get('time_label', '0s'))}</b>\n\n"
...
async def handle_inline_query(update: Update, context) -> None:
    ...
    for row in filtered:
        ...
        text = (
            ...
            f"Time / question: <b>{base.fmt_question_time(row['question_time'])}</b>\n"
